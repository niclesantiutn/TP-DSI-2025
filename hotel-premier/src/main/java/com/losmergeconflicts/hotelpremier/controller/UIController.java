...
public class UIController {
    ...
    @Operation(summary = "Mostrar interfaz de búsqueda de huésped",
                description = "Renderiza la página HTML con la interfaz para buscar huéspedes en el sistema.",
                responses = {
                    @ApiResponse(responseCode = "200", description = "Interfaz de búsqueda mostrada exitosamente"),
                    @ApiResponse(responseCode = "401", description = "No autenticado - Redirige al login")
                })
    @GetMapping("/huesped/buscar")
    public String mostrarBusquedaHuesped(Model model) {
